...
**Senza Luna e con la Luna sono due numeri diversi.** Il tempo di posa mostrato per ogni target è quello senza Luna lungo il suo percorso reale nella notte scelta (altezza, estinzione, cielo e luci nella sua direzione a ogni passo di 5 minuti): è quanto chiede il target sotto quel cielo, e si confronta fra luoghi e filtri. Con lo stesso profilo, un terrazzo di città (SQM 19,25) contro un sito a SQM 21,7, la Cocoon passa da 71 h a 9 h e le nebulose oscure fanno lo stesso (circa ×8, in linea con 60 h contro 6 h misurate davvero), mentre in banda stretta NGC 7000 passa solo da 1,9 a 1,2 h. Quanto costerebbe con la Luna della notte scelta è indicato a parte (con la Luna piena i due cieli si somigliano: ×1,3). Nel profilo si sceglie se il calendario delle notti usa anche le notti con la Luna, col loro rallentamento, o solo le ore senza Luna.
