...
window.FILTER_DB = [
  ...
  { id: 'triband2', brand: 'Antlia', name: 'Triband RGB Ultra II', for: 'osc', kind: 'lp', bands: [[478, 503, 0.9], [520, 545, 0.9], [650, 675, 0.93]], approx: true, src: 'https://www.cloudynights.com/articles/astro-gear-today/reviews/a-hybrid-light-pollution-filter-for-color-imaging-antlia-triband-rgb-ultra-review-r4632/', note: 'tre bande di ~25 nm (Hβ/OIII, verde, Hα/NII/SII); centri stimati' },
